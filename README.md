...
│   ├── routes/                    # Modular blueprints (cognitive, demo, fusion, gaze, inspector)
...
### Cognitive Capability Inspector (`/api/inspector/*`)
- `POST /api/inspector/analyze`: Analyze gaze history and yield capability metrics profile
- `POST /api/inspector/report`: Compile detailed markdown diagnostic report
- `GET /api/inspector/reports`: List all saved markdown capability reports
- `GET /api/inspector/reports/<filename>`: Fetch raw markdown content of a specific report
- `DELETE /api/inspector/reports/<filename>`: Delete a saved report from disk
