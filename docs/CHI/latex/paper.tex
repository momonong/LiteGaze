...
Module & Topic & Owner \\
\midrule
M1 & Gaze / UniGaze / calibration & Shengwen Chang \\
M2 & Data collection \& training demo & Bowei Huang \\
M3 & Cognitive load pipeline & Weichi Lin \\
M4 & Spatiotemporal alignment & Chenghao Peng \\
M5 & Trajectory fusion \& RDS & Jhennong Chen \\
\bottomrule
\end{tabular}
\end{table}
...
While spatial baselines perform well under low drift ($<30$\,px), they collapse under high noise. STOCK-T's transition matrix prevents vertical line leakage, maintaining $10.14\%$ word accuracy and $40.24\%$ line recovery at $60$\,px drift, outperforming the baseline by \textbf{+23.1\% relative word accuracy}.
