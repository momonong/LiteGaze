...
Module & Topic & Owner \\
\midrule
M1 & Gaze / UniGaze / calibration & Shengwen \\
M2 & Data collection \& training demo & BoWei \\
M3 & Cognitive load pipeline & Weichi \\
M4 & Spatiotemporal alignment & Chenghao \\
M5 & Trajectory fusion \& RDS & Jhennong \\
Web & Flask UI, Inspector & Chenghao, BoWei, Jhennong \\
\bottomrule
\end{tabular}
\end{table}
